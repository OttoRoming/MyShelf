...
<style>
	/* 3D Hover Effect from DaisyUI */
	/* https://github.com/saadeghi/daisyui/blob/de213728084450b81d683cb01795205a3b518941/packages/daisyui/src/components/hover3d.css */
	.hover-3d {
		@layer daisyui.l1.l2.l3 {
			...
			filter: drop-shadow(var(--shadow) 0.1rem #00000003)
				drop-shadow(var(--shadow) 0.2rem #00000003) drop-shadow(var(--shadow) 0.3rem #00000003)
			...
			> :first-child {
				...
				outline-offset: -1px;
				&:before {
					width: calc(1 / 3 * 100%) /* 33.333333% */;
					height: calc(1 / 3 * 100%) /* 33.333333% */;
					content: '';
					pointer-events: none;
					position: absolute;
					z-index: 1;
